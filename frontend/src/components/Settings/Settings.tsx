          ...
          {store && (
            <>
              ...
              <SelectField
                ...
                options={{
                  ...
                  ...Object.fromEntries(
                    Object.keys(maps)
                      .sort()
                      .map((palette) => [palette, unhyphenate(palette)])
                  ),
                }}
                isSmall
                value={store.colormap}
                onChange={(event) =>
                  store.setColormap(event.target.value as MapKey)
                }
              />
              ...
              <SelectField
                ...
                options={{
                  ...Object.fromEntries(
                    Object.entries(languageDetails).map(([id, details]) => [
                      id,
                      details.name,
                    ])
                  ),
                ...
                onChange={(e) => {
                  ...
                  if (isKeyOfObject(e.target.value, languageDetails)) {
                    store.setTimeFormat(
                      languageDetails[e.target.value].timeFormat
                    );
                    store.setWeekStart(
                      languageDetails[e.target.value].weekStart
                    );
                  }
