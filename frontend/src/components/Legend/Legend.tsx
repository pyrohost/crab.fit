          ...
          .map((i, j) => (
            <div
              ...
              style={
                {
                  flex: 1,
                  backgroundColor: palette[j].string,
                  "--highlight-color": palette[j].highlight,
                } as React.CSSProperties
              }
              className={
                highlight && i === max && max > 0 ? styles.highlight : undefined
              }
